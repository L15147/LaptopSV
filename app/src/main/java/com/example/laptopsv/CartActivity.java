...
import com.example.laptopsv.Adapter.CartAdapter;
import com.example.laptopsv.Interface.OnWidgetRecycleviewClicked;
import com.example.laptopsv.Model.HoaDon;
...
public class CartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cartAdapter = new CartAdapter(com.example.laptopsv.HomeActivity.listFoodOrder);
        ...
        if (com.example.laptopsv.HomeActivity.listFoodOrder.size() > 0) {
            thanhTien = 0;
            for (int i = 0; i < com.example.laptopsv.HomeActivity.listFoodOrder.size(); i++) {
                thanhTien += (int) com.example.laptopsv.HomeActivity.listFoodOrder.get(i).getThanhTien();
            }
        ...
        btnThanhToan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //check rỗng
                if(com.example.laptopsv.HomeActivity.listFoodOrder.size() <1){
                ...
                builder.setPositiveButton("Xác nhận", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        HoaDon hoaDon = new HoaDon(com.example.laptopsv.MainActivity.user,mDate, com.example.laptopsv.HomeActivity.listFoodOrder,thanhTien);
                        ...
                        com.example.laptopsv.HomeActivity.listFoodOrder.clear();

                        Intent intent = new Intent(CartActivity.this, com.example.laptopsv.HomeActivity.class);
